...
@senswap/sen-scripts/0.0.17 darwin-x64 node-v14.16.1
...
_See code: [src/commands/payer.ts](https://github.com/DescartesNetwork/sen-scripts/blob/v0.0.17/src/commands/payer.ts)_
...
_See code: [src/commands/program.ts](https://github.com/DescartesNetwork/sen-scripts/blob/v0.0.17/src/commands/program.ts)_
...
_See code: [src/commands/soprox.ts](https://github.com/DescartesNetwork/sen-scripts/blob/v0.0.17/src/commands/soprox.ts)_
<!-- commandsstop -->
